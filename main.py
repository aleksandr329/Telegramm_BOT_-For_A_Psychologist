...
def start(message):
    ...
    text = f''' <b>{message.from_user.first_name}</b>, прежде чем пройти тест, давайте познакомимся!
...
Сейчас я расскажу, <b>как связаны самооценка человека и его отношения, карьера и уровень дохода.</b> '''
    ...
    text2 = f''' 
Что позволяет <b>стабильная и адекватная самооценка?</b>
...
<b>•</b>	свободно и легко <b>вести блог и выражать своё мнение</b> в жизни и в интернете, <b>без оглядки на осуждение или критику</b>  коллег, родственников, друзей, хейтеров
...
def get_user_text(message):
    ...
    if message.text == 'КОНСУЛЬТАЦИЯ':
        text = '''
Консультация (онлайн или оффлайн) - 57 минут:
 ...
 24 консультации – 67 000 руб.'''
    ...
    if message.text == 'ЛИЧНОЕ СОПРОВОЖДЕНИЕ':
        text = '''
Личное сопровождение включает <b>консультации и дополнительную работу в телеграмм + домашние задания.</b>
...
6 месяцев – 107 000 руб.'''
    ...
    if message.text == 'РАБОТА В ГРУППЕ':
        text = '''
Работа в онлайн-группе по теме укрепления самооценки в течение 1 месяца. 
Стоимость - 7 000 руб.'''
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1)
        btn32 = types.KeyboardButton('ЗАПИСАТЬСЯ')
        btn33 = types.KeyboardButton('Начать все сначала 🔄')
    ...
    Ваша самооценка зависит от одобрения и принятия со стороны окружающих. А чтобы это одобрение получить, Вы считаете, что должны соответствовать ожиданиям других людей.
    ...
    Не знаете, чего хотите и как будто совсем нет энергии. Не верите, что можете добиться существенных успехов.</b>'''
        ...
        time.sleep(15)
        text2 = '''
        Персональная стратегия для укрепления самооценки: 
        ...
        быть самым главным человеком в своей жизни – это большая смелость, которая даёт возможность отстаивать себя и свои интересы! Учитесь этому и делайте маленькие шаги в данном направлении. 
        <b>•	Учитесь просить о помощи:</b>
        Вы привыкли всё делать самостоятельно, чтобы никого не напрягать. Попробуйте сделать иначе – попросите близких о помощи и увидите, как это облегчит вашу жизнь!
...
Презираете проявление слабости в других, и не признаёте её в себе, предпочитая надевать маску «сильного человека». Не поддаётесь давлению, не признаёте ошибок и не доверяете людям.
...
<b>•	Расслабьтесь:</b> 
Вы много сил тратите на доказательство своей силы. Если принимать себя такой, как есть, со всеми плюсами и минусами, это позволит избежать лишнего напряжения.
<b>•	Принятие собственных эмоций:</b> 
Испытывать грусть, страх, скуку, волнения, жалость – это нормально для всех людей. Без этих эмоций спектр ощущений человека неполноценен, поэтому необходимо разрешать себе в них погружаться.
...
Ваше ощущение себя не зависит от внешних обстоятельств. Можете сориентироваться в изменчивой реальность, при этом оставаясь спокойным и практичным человеком.</b>'''
        ...
        text2 = '''
<b>У ВАС УЖЕ ХОРОШИЙ ФУНДАМЕНТ для достижения ваших целей и желаний.</b> Иногда для того, чтобы <b>жить собственной жизнью</b> надо немного поработать. 
Например, научиться выражать агрессию, чтобы управлять своими границами и <b>проявлять любовь.</b> Познакомиться поближе со стыдом и виной, чтобы строить <b>здоровые отношения с собой и окружающими.</b> 

Я помогаю клиенту выбирать <b>в жизни то, что ему важно,</b> но по каким-то причинам сложно. Осознать эти причины, сделать их явными и <b>найти способ получения желаемого</b> - это красивый 
психотерапевтический процесс, в котором я сопровождаю клиента!
...
Каждый человек уникален, и в тоже время всегда есть кто-то быстрее, выше, сильнее вас – это бесконечная гонка. Обратите внимание на СВОИ цели, желания, особенности, раскрывайте их и наслаждайтесь собой без сравнения с остальным миром. 
...
Посмотрите на ваше окружение, как на людей с их чувствами, эмоциями, переживаниями. Ведь достижения, это только часть жизни, есть ещё и более тонкие планы. Рассмотреть в человеке – Человека, вот главная задача! 
Обращая внимание на этот аспект, вы перестанете воспринимать людей как «функцию» или «шкалу достижений», по которой равняете и себя.
<b>•	Мотивация и цель:</b>
Когда начинаете новое дело, на берегу определитель с той целью, ради которой это дело затеваете. В те моменты, когда захочется всё бросить, вспоминайте и мотивируйте себя, тогда довести дело до конца будет намного легче.
'''
        bot.send_message(message.chat.id, text2, parse_mode='HTML')
        time.sleep(15)
        video4 = open('video/video4.mp4', 'rb')
...
if __name__ == "__main__":
    ...
    try:
        ...
        c = [5851216128]
        for i in c:
            bot.send_message(i, 'ТелеграмБОТ Kytty скоро упадет')
